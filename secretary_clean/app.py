...
def _seed_from_env(repository) -> None:
    ...
    if not email or not password or not company_name:
        log.warning("Seed skipped -- SEED_ADMIN_EMAIL / SEED_ADMIN_PASSWORD / SEED_COMPANY_NAME not set.")
        return
    ...
    try:
        ...
        log.info("Seed complete -- company=%s  admin=%s", result.company.id, result.admin.email)
    except Exception as exc:
